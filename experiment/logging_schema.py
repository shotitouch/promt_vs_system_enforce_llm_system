...
AuthorityOwner = Literal["llm", "deterministic", "none"]
...
class PolicyTrace(BaseModel):
    ...
    scope_category: Optional[Literal["in_scope", "out_of_scope", "unknown"]] = None
...
class ExpressionTrace(BaseModel):
    answer_format: Optional[Literal["refuse", "error", "scalar", "table_preview", "empty"]] = None
...
class ExperimentRecord(BaseModel):
    ...
    refusal_source: Optional[
        Literal["policy", "validation", "intent", "aggregation", "expression", "other"]
    ] = None
    ...
    # Expression boundary / reproducibility
